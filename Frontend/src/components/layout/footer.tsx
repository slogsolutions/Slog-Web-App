            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="flex flex-col space-y-1 ml-6">
                  ...
                  <a href="tel:7456000241" className="text-gray-300 hover:text-teal-600 text-sm transition-colors">
                    +91 7456000241
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-col space-y-1 ml-6">
                  ...
                  <a href="tel:7456000244" className="text-gray-300 hover:text-green-400 text-sm transition-colors">
                    +91 7456000244
                  </a>
                </div>
              </div>
